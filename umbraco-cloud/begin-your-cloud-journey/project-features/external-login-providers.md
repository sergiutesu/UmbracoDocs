...
External login providers can also be configured for access to the Cloud Portal. For more information, see [Organization Login Providers](../the-cloud-portal/organizations/organization-login-providers.md).
{% endhint %}
